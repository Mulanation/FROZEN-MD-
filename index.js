...
const {
  ...
  const ownerNumber = ['263776504487']
...
async function loadSession() {
    try {
        ...
        // Remove "FROZEN~" prefix if present, otherwise use full SESSION_ID
        const megaFileId = config.SESSION_ID.startsWith('FROZEN~') 
            ? config.SESSION_ID.replace("FROZEN~", "") 
            : config.SESSION_ID;
...
async function connectToWA() {
    console.log("[🔰] FROZEN-MD Connecting to WhatsApp ⏳️...");
    ...
    conn.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            console.log('[🔰] FROZEN-MD connected to WhatsApp ✅');
            ...
            console.log('[🔰] Plugins installed successfully ✅');
                ...
                try {
                    ...
                    const upMessage = `╭─〔 *🤖 FROZEN-MD BOT* 〕  
├─▸ *Ultra Super Fast Powerfull ⚠️*  
│     *World Best BOT KHAN-MD* 
╰─➤ *Your Smart WhatsApp Bot is Ready To use 🍁!*  

- *🖤 Thank You for Choosing FROZEN-MD!* 
...
├─ 🌟 *Star the Repo:*  
│    https://github.com/Mulanation/FROZEN-MD  
╰─🚀 *Powered by Youngboy-Dev*`;
